...
const PartialSetting : React.FC<Props> = (props: Props) =>{
  ...
  return (
      <div className='setting'  style={{display: props.open ? "block" : "none"}}>
        <div className='setting-title'><div>개별 설정</div> <div onClick={props.handleClickPartialSetting} style={{cursor:'pointer'}}>X</div></div>
        <div className='setting-content'>
          ...
          <div className="setting-item"><select name="" id="" defaultValue={0.5}><option value="0.5">v 0.5</option></select></div>
          <div className="setting-text">적용기술</div>
          <div className="setting-item"><select name="" id="" defaultValue={0.5}><option value="0.5">컬러 (lab_rgb)</option></select></div>
          ...
          <div className='setting-reset'>기본 설정 초기화</div>
        </div>
      </div>
